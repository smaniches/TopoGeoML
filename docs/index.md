...
Quality floor: 497 tests; 100% line coverage on the `topogeoml` package with full dependencies (the `benchmarks/` research harness is below 100%); mypy strict; ruff clean.
