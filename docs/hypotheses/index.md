...
| **H009-R** | Corrective replication: does the repaired scalar sheaf Laplacian resolve H39-H41? | H39 supported (sheaf 0.604 above MLP 0.523, p_BH = 4.73 x 10^-3); H40 not supported (sheaf versus Hodge p_BH = 0.428); H41 falsification condition not met (sheaf below gin-residual at p_BH = 0.0342, which does not cross the preregistered 0.01 threshold; inconclusive, not equivalence) |
