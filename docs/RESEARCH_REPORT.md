...
> **Historical snapshot.** This report is the Version 0.0.2 research record through H008c and is preserved as written. The current project state through H011b is maintained in [STATUS.md](../STATUS.md), [STATISTICAL_SUMMARY.md](STATISTICAL_SUMMARY.md), and [CLAIMS_TO_EVIDENCE.md](CLAIMS_TO_EVIDENCE.md).
