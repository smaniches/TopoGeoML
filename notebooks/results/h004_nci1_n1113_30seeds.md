...
- Schema: `hodge-1.0.0`
- Timestamp (UTC): 2026-05-21T23:34:58Z
...
|---|---|---|---|
| `hodge-mp-residual` | `nci1` | 0.601 [0.589, 0.629] | 30 |
| `mlp-baseline` | `nci1` | 0.549 [0.526, 0.590] | 30 |

## Pairwise Wilcoxon signed-rank (paired) + Benjamini-Hochberg FDR

| Dataset | A | B | median Δ | p_raw | p_BH | Effect (r) | Verdict |
|---|---|---|---|---|---|---|---|
| nci1 | `hodge-mp-residual` | `mlp-baseline` | +0.0516 | 4.490e-02 | 4.490e-02 | 0.333 | **hodge-mp-residual ≠ mlp-baseline** |
