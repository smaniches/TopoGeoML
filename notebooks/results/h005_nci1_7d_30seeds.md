...
- Schema: `hodge-1.0.0`
- Timestamp (UTC): 2026-05-22T00:43:34Z
...
|---|---|---|---|
| `hodge-mp-residual` | `nci1` | 0.581 [0.525, 0.598] | 30 |
| `mlp-baseline` | `nci1` | 0.500 [0.500, 0.518] | 30 |

## Pairwise Wilcoxon signed-rank (paired) + Benjamini-Hochberg FDR

| Dataset | A | B | median Δ | p_raw | p_BH | Effect (r) | Verdict |
|---|---|---|---|---|---|---|---|
| nci1 | `hodge-mp-residual` | `mlp-baseline` | +0.0809 | 4.927e-04 | 4.927e-04 | 0.643 | **hodge-mp-residual ≠ mlp-baseline** |
